FORBIDDEN_KEYWORDS = [
    ...
    "family", "wife", "spouse", "kids", "children", "parents",
    ...
    # Financial
    "salary", "how much do you earn", "dinero", "sueldo", "cuánto ganas",
    "income",

    # Personal life
    "religion", "politics", "beliefs",
    "religión", "política", "creencias", "orientación sexual",

    # Physical identity
    "appearance", "height", "weight",
    "altura", "peso", "apariencia",

    # Exact address/bio queries
